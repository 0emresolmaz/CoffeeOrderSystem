...
public class OSQKPSPublicSoap
{
    ...
    public OSQKPSPublicSoap(){}

    public OSQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OSQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OSQExtendedSoapSerializationEnvelope envelope= new OSQExtendedSoapSerializationEnvelope(OSQExtendedSoapSerializationEnvelope.VER11);
