...
public class OSQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OSQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OSQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OSQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OSQDateTimeConverter dateTimeConverter = new OSQStandardDateTimeConverter();

    public OSQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OSQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OSQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OSQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OSQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OSQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
